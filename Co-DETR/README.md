...
- ViT-l backbone [Google Drive]()
- ViT-l backbone + basic augmentation [Google Drive]()
- ViT-l backbone + rotation augmentation [Google Drive]()
- ViT-l backbone + SR [Google Drive]()
- Swin backbone + Semi-supervision [Google Drive]()
...
### From now on, the original repository contents
