...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'data/Fisheye8K/train/train_aicity_sr.json',
        img_prefix=data_root + 'data/outputs_fisheye_train/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'data/Fisheye8K/test/test_aicity.json',
        img_prefix=data_root + 'data/Fisheye8K/test/images/',
