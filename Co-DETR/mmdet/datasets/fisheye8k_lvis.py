...
class Fisheye8klvisDataset(CustomDataset):
    ...
    def format_results(self, results, jsonfile_prefix=None, **kwargs):
        ...
        if jsonfile_prefix is None:
            ...
            tmp_dir = None
        result_files = self.results2json(results, '/workspace/results')
    ...
    def evaluate_det_segm(self,
        ...
        for metric in metrics:
            ...
            if metric == 'proposal':
                ...
                # for image_evaluation_dict in cocoEval.evalImgs:
                #     # pdb.set_trace()
                #     # print("-" * 30)
                #     if image_evaluation_dict is None:
                #         continue
                #     cat_id = image_evaluation_dict['category_id']
                ...
                # class_dict = {i:c for i, c in enumerate(self.CLASSES)}
                # class_dict[len(self.CLASSES)] = 'all'
                # # class_dict = {0: 'bus', 1:'bike', 2:'car', 3:'ped', 4:'truck', 5:'all'}
                # for i, (total_tp, total_fp, total_gt) in enumerate(zip(tps, fps, gts)):
                ...
                #     print(f"{class_dict[i]} | {precision:0.4f} | {recall:0.4f} | {f1:0.4f}")
